...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/147_publish_french_6e_lot_03.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot F6-GRA-03 after its 20 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  where legacy_id between 1000061 and 1000080;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000061 and 1000080
  ),
  latest_reviews as (
