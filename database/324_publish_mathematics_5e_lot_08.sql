/*
 ...
 File: database/324_publish_mathematics_5e_lot_08.sql
 Purpose: Publish Mathematics 5e lot M5-FRAC-02 after 20 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000241 and 5000260;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000241 and 5000260
  ),
  latest_reviews as (
