/*
 ...
 File: database/403_publish_mathematics_5e_lot_20.sql
 Purpose: Publish Mathematics 5e lot 20 after 30 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000611 and 5000640;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000611 and 5000640
  ),
  latest_reviews as (
