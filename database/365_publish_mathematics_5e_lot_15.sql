/*
 ...
 File: database/365_publish_mathematics_5e_lot_15.sql
 Purpose: Publish Mathematics 5e lot 15 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000451 and 5000490;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000451 and 5000490
  ),
  latest_reviews as (
