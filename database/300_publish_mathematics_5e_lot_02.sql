/*
 ...
 File: database/300_publish_mathematics_5e_lot_02.sql
 Purpose: Publish Mathematics 5e lot M5-OPS-02 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000041 and 5000080;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000041 and 5000080
  ),
  latest_reviews as (
