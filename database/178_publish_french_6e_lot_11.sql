/*
 ...
 File: database/178_publish_french_6e_lot_11.sql
 Purpose: Publish French 6e lot F6-CON-11 after 40 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000309 and 1000348;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000309 and 1000348
  ),
  latest_reviews as (
