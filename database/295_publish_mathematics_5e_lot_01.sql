/*
 ...
 File: database/295_publish_mathematics_5e_lot_01.sql
 Purpose: Publish Mathematics 5e lot M5-OPS-01 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000001 and 5000040;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000001 and 5000040
  ),
  latest_reviews as (
