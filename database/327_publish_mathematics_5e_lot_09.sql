/*
 ...
 File: database/327_publish_mathematics_5e_lot_09.sql
 Purpose: Publish Mathematics 5e lot M5-POW-01 after 20 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000261 and 5000280;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000261 and 5000280
  ),
  latest_reviews as (
