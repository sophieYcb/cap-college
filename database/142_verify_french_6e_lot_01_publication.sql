...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/142_verify_french_6e_lot_01_publication.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Verify publication of French 6e lot F6-GRA-01.
 Read-only    : Yes
===============================================================================
*/
...
select jsonb_build_object(
  ...
  'version_3_questions', (
    select count(*) from lot_questions where current_version_number = 3
  )
) as verification;
