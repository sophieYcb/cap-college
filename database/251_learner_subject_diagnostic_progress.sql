/*
 ...
 File: database/251_learner_subject_diagnostic_progress.sql
 Purpose: Return learner diagnostic progress for one explicitly requested subject.
 Idempotent: Yes
*/

begin;

create or replace function public.get_learner_subject_diagnostic_progress(
...
begin
  ...
  select jsonb_build_object(
    ...
    'ruleVersion', 'reliable-v1-subject',
    'skills', (
...
revoke all on function public.get_learner_subject_diagnostic_progress(text, text)
  from public;
grant execute on function public.get_learner_subject_diagnostic_progress(text, text)
