/*
 ...
 File: database/330_publish_mathematics_5e_lot_10.sql
 Purpose: Publish Mathematics 5e lot M5-POW-02 after 30 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000281 and 5000310;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000281 and 5000310
  ),
  latest_reviews as (
