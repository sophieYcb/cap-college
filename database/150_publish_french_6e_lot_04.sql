...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/150_publish_french_6e_lot_04.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot F6-GRA-04 after its 20 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000081 and 1000120
  ),
  latest_reviews as (
