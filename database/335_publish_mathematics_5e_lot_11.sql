/*
 ...
 File: database/335_publish_mathematics_5e_lot_11.sql
 Purpose: Publish Mathematics 5e lot M5-ALG-01 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000311 and 5000350;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000311 and 5000350
  ),
  latest_reviews as (
