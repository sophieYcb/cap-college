/*
 ...
 File: database/303_publish_mathematics_5e_lot_03.sql
 Purpose: Publish Mathematics 5e lot M5-OPS-03 after 30 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000081 and 5000110;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000081 and 5000110
  ),
  latest_reviews as (
