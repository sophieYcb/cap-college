/*
 ...
 File: database/396_publish_mathematics_5e_lot_19.sql
 Purpose: Publish Mathematics 5e lot 19 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000571 and 5000610;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000571 and 5000610
  ),
  latest_reviews as (
