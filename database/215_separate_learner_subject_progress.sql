/*
 ...
 File: database/215_separate_learner_subject_progress.sql
 Purpose: Select learner progress from the subject of the latest session.
 Idempotent: Yes
*/
...
revoke all on function public.get_learner_diagnostic_progress(text) from public;
grant execute on function public.get_learner_diagnostic_progress(text) to anon, authenticated;
