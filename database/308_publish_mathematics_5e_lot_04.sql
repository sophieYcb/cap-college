/*
 ...
 File: database/308_publish_mathematics_5e_lot_04.sql
 Purpose: Publish Mathematics 5e lot M5-REL-01 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000111 and 5000150;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000111 and 5000150
  ),
  latest_reviews as (
