/*
 ...
 File: database/340_publish_mathematics_5e_lot_12.sql
 Purpose: Publish Mathematics 5e lot M5-ALG-02 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000351 and 5000390;
