/*
 ...
 File: database/373_publish_mathematics_5e_lot_16.sql
 Purpose: Publish Mathematics 5e lot 16 after 30 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000491 and 5000520;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000491 and 5000520
  ),
  latest_reviews as (
