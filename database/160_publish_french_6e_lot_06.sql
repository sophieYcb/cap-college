/*
 ...
 File: database/160_publish_french_6e_lot_06.sql
 Purpose: Publish French 6e lot F6-GRA-06 after 40 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000161 and 1000200;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000161 and 1000200
  ),
  latest_reviews as (
