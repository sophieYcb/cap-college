/*
 ...
 File: database/196_publish_french_6e_lot_15.sql
 Purpose: Publish French 6e lot F6-ORT-15 after 10 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000459 and 1000468;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000459 and 1000468
  ),
  latest_reviews as (
