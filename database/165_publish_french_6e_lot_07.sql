/*
 ...
 File: database/165_publish_french_6e_lot_07.sql
 Purpose: Publish French 6e lot F6-GRA-07 after 30 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000201 and 1000230;
