/*
 ...
 File: database/194_publish_french_6e_lot_14.sql
 Purpose: Publish French 6e lot F6-ORT-14 after 30 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000429 and 1000458;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000429 and 1000458
  ),
  latest_reviews as (
