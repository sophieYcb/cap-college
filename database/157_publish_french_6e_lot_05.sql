/*
 ...
 File: database/157_publish_french_6e_lot_05.sql
 Purpose: Publish French 6e lot F6-GRA-05 after 40 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000121 and 1000160;
