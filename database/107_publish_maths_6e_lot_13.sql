...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/107_publish_maths_6e_lot_13.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot M6-MES-02 after its 40 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  where legacy_id between 600461 and 600500;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 600461 and 600500
  ),
  latest_reviews as (
