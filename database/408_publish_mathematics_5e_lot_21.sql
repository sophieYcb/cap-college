/*
 ...
 File: database/408_publish_mathematics_5e_lot_21.sql
 Purpose: Publish Mathematics 5e lot 21 after 40 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000641 and 5000680;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000641 and 5000680
  ),
  latest_reviews as (
