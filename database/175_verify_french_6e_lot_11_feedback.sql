/*
 ...
 File: database/175_verify_french_6e_lot_11_feedback.sql
 Purpose: Verify validator-feedback corrections for French 6e lot F6-CON-11.
 Read-only: Yes
*/

with expected(legacy_id, correct_position) as (
  values
    (1000317,1),(1000320,4),(1000324,4),(1000329,1),
    (1000330,2),(1000331,3),(1000332,4),(1000333,1),
    (1000334,2),(1000335,3),(1000336,4),(1000337,1),
    (1000338,2),(1000340,4)
),
corrected as (
  select
