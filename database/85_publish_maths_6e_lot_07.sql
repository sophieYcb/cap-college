...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/85_publish_maths_6e_lot_07.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot M6-FRAC-01 after its 40 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  with current_versions as (
    ...
    where q.legacy_id between 600241 and 600280
  ),
  latest_reviews as (
