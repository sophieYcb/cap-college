/*
 ...
 File: database/352_publish_mathematics_5e_lot_14.sql
 Purpose: Publish Mathematics 5e lot 14 after 30 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000421 and 5000450;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000421 and 5000450
  ),
  latest_reviews as (
