...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/144_publish_french_6e_lot_02.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot F6-GRA-02 after its 20 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  where legacy_id between 1000041 and 1000060;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000041 and 1000060
  ),
  latest_reviews as (
