/*
 ...
 File: database/168_publish_french_6e_lot_08.sql
 Purpose: Publish French 6e lot F6-GRA-08 after 40 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000231 and 1000270;
