/*
 ...
 File: database/182_publish_french_6e_lot_12.sql
 Purpose: Publish French 6e lot F6-CON-12 after 40 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000349 and 1000388;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000349 and 1000388
  ),
  latest_reviews as (
