/*
 ...
 File: database/186_publish_french_6e_lot_13.sql
 Purpose: Publish French 6e lot F6-ORT-13 after 40 grade-A validations.
 Idempotent: Yes
*/
...
begin
  ...
  where legacy_id between 1000389 and 1000428;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 1000389 and 1000428
  ),
  latest_reviews as (
