...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/90_publish_maths_6e_lot_08.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot M6-FRAC-02 after its 40 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  where legacy_id between 600281 and 600320;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 600281 and 600320
  ),
  latest_reviews as (
