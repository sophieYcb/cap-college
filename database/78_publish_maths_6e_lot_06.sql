...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/78_publish_maths_6e_lot_06.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot M6-CALC-02 after its 40 grade-A validations.
===============================================================================
*/
...
begin
  ...
  with current_versions as (
    ...
    where q.legacy_id between 600201 and 600240
  ),
  latest_reviews as (
