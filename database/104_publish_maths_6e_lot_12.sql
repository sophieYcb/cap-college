...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/104_publish_maths_6e_lot_12.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot M6-MES-01 after its 40 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  where legacy_id between 600421 and 600460;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 600421 and 600460
  ),
  latest_reviews as (
