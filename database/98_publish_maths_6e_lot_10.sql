...
-------------------------------------------------------------------------------
 Version      : 1.0.0
 File         : database/98_publish_maths_6e_lot_10.sql
 Target       : PostgreSQL / Supabase
 Purpose      : Publish lot M6-FRAC-PCT-01 after its 40 grade-A validations.
 Idempotent   : Yes
===============================================================================
*/
...
begin
  ...
  where legacy_id between 600361 and 600400;
  ...
  with current_versions as (
    ...
    where q.legacy_id between 600361 and 600400
  ),
  latest_reviews as (
