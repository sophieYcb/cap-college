/*
 ...
 File: database/345_publish_mathematics_5e_lot_13.sql
 Purpose: Publish Mathematics 5e lot M5-ALG-03 after 30 grade-A validations.
 Idempotent: Yes.
*/
...
begin
  ...
  where legacy_id between 5000391 and 5000420;
  ...
  with current_versions as (
    ...
    where question.legacy_id between 5000391 and 5000420
  ),
  latest_reviews as (
